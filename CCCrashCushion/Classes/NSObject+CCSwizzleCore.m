...
@implementation NSObject (CCSwizzleCore)
...
+ (BOOL)cc_swizzleClassMethod:(SEL)origSel_ withClassMethod:(SEL)altSel_ error:(NSError**)error_ {
    return [GetClass((id)self) cc_swizzleMethod:origSel_ withMethod:altSel_ error:error_];
}

+ (NSInvocation*)cc_swizzleMethod:(SEL)origSel withBlock:(id)block error:(NSError**)error {
    IMP blockIMP = imp_implementationWithBlock(block);
    NSString *blockSelectorString = [NSString stringWithFormat:@"_cc_block_%@_%p", NSStringFromSelector(origSel), block];
    ...
    [self cc_swizzleMethod:origSel withMethod:blockSel error:nil];
    
    return origInvocation;
}

+ (NSInvocation*)cc_swizzleClassMethod:(SEL)origSel withBlock:(id)block error:(NSError**)error {
    NSInvocation *invocation = [GetClass((id)self) cc_swizzleMethod:origSel withBlock:block error:error];
